...
| P05a | Lock mode | Tela escurecida durante gravação. REC dot + timer mirror. | double-tap → P05 |
...
| P11 | Termos de Uso | Texto legal scrollável | back → origem |
| P12 | Política de Privacidade | Texto legal scrollável | back → origem |
...
| M02 | Onboarding Xiaomi MIUI | Auto: 1ª abertura em device MIUI / Manual: Settings → Sobre |
| M03 | Controle Bluetooth conectado | Auto: detecção de fone BT que reporta como volume button |
